...
public class ExploreFragment extends BaseFragment<FragmentExploreListCourseBinding> {
    ...
    protected void setupViews() {
        ...
        adapter = new CourseAdapter(courseList, course -> {
            android.content.Intent intent = new android.content.Intent(requireContext(), com.example.myapplms.ui.course.CourseDetailActivity.class);
            intent.putExtra(com.example.myapplms.ui.course.CourseDetailActivity.EXTRA_COURSE_ID, course.getCourseId());
    ...
    private void loadSampleData() {
        courseList.add(new Course(1, "E-Learning Platform Overview", "by Dr. Sarah Chen", "4.9 (1.2k)", "125k students", "18 lessons", "2h 30m", "FREE", "Development", "Beginner", R.drawable.ic_launcher_background));
        courseList.add(new Course(2, "Advanced Android Development", "by John Doe", "4.8 (850)", "50k students", "24 lessons", "5h 45m", "$49.99", "Development", "Advanced", R.drawable.ic_launcher_background));
        courseList.add(new Course(3, "UI/UX Design Fundamentals", "by Jane Smith", "4.7 (2.1k)", "200k students", "12 lessons", "3h 15m", "FREE", "Design", "Beginner", R.drawable.ic_launcher_background));
