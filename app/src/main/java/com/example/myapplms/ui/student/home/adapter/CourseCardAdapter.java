...
import com.example.myapplms.databinding.ItemHomeCourseCardBinding;
...
public class CourseCardAdapter extends RecyclerView.Adapter<CourseCardAdapter.ViewHolder> {
    ...
    public CourseCardAdapter(OnCourseClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemHomeCourseCardBinding binding = ItemHomeCourseCardBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ItemHomeCourseCardBinding binding;
        ViewHolder(ItemHomeCourseCardBinding binding) {
        ...
        void bind(Course course, OnCourseClickListener listener) {
            ...
            binding.tvLevel.setText(course.level);
            binding.tvCategory.setText(course.category);
            binding.tvDuration.setText(course.duration);
            binding.tvStudents.setText(course.students);
            binding.tvLessons.setText(course.lessons);
